...
function Tagger({ field, onChange }) {
    ...
    const [poptions, setPoptions] = reactExports.useState(currentGroup.options);
    ...
    const handleChange = (changes) => {
        ...
        if (changes.inputValue !== undefined) {
            if (changes.inputValue === "") {
                ...
                setPoptions(currentGroup.options.filter((poption) => poption.label.match(regex)));
            }
        }
    };
    return (jsxRuntimeExports.jsxs(Field$1, { children: [jsxRuntimeExports.jsxs(Label$1, { children: [label, required && jsxRuntimeExports.jsx(Span, { "aria-hidden": "true", children: "*" })] }), description && (jsxRuntimeExports.jsx(Hint$1, { dangerouslySetInnerHTML: { __html: description } })), jsxRuntimeExports.jsxs(Combobox, { ref: wrapperRef, inputProps: { required, name }, isEditable: true, isAutocomplete: true, validation: error ? "error" : undefined, onChange: handleChange, selectionValue: selectionValue, renderValue: ({ selection }) => selection?.label ?? jsxRuntimeExports.jsx(EmptyValueOption, {}), isExpanded: isExpanded, children: [currentGroup.type === "SubGroup" && (jsxRuntimeExports.jsx(Option, { ...currentGroup.backOption })), currentGroup.type === "SubGroup" ? (jsxRuntimeExports.jsx(OptGroup, { "aria-label": currentGroup.name, children: poptions.map((poption) => (jsxRuntimeExports.jsx(Option, { ...poption, children: poption.menuLabel ?? poption.label }, poption.value))) })) : (poptions.map((poption) => poption.value === "" ? (jsxRuntimeExports.jsx(Option, { ...poption, children: jsxRuntimeExports.jsx(EmptyValueOption, {}) }, poption.value)) : (jsxRuntimeExports.jsx(Option, { ...poption }, poption.value))))] }), error && jsxRuntimeExports.jsx(Message$1, { validation: "error", children: error })] }));
}
